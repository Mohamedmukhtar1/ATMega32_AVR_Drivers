...
/*  triggering function   U8 Auto_Trigering_Conig
***********ADC_AUTO_TRIGGERING_MODE for ADCSRA Register & SOURCE for SFIOR Register**********
switch(Auto_Trigering_Conig)
{
	case AUTO_TRIGERING_ON:
	break;
	case AUTO_TRIGERING_ON:
	break;
	default:
...
#if		AUTO_TRIGERING_MODE		==   AUTO_TRIGERING_ON
SET_BIT(REG_ADCSRA,ADC_ADCSRA_ADATE);
#if AUTO_TRIGERING_SOURCE	== SFIOR_SOURCE_FREE_RUNNING_MODE
